...
class EuPostSeeder extends Seeder
{
    ...
    const PROJECTS = [
        ...
        [
            "title" => "ALL4YOUTH- Δίκτυο Δεξιοτήτων για τη Νεολαία",
            "startsFrom" => "2023-09-01",
            "endsAt" => "2025-08-31",
            "partners" => [
                ["name" => "YOUTH ACTION", "country" => "Ελλάδα"],
                ["name" => "FORUM ORGANISATIONS", "country" => "Γερμανία"],
                ["name" => "YOUTH ENTERPRISE", "country" => "Πολωνία"],
                ["name" => "EAST EUROPE GROUP", "country" => "Αγγλία"]
            ],
            "website" => "",
            "authority" => "Ευρωπαϊκή Επιτροπή",
            "program_managing_entity" => "ERASMUS+",
            "description" => "Το έργο All4Youth αναπτύσσει ένα Δίκτυο Δεξιοτήτων για τη Νεολαία, προσφέροντας προγράμματα και εκδηλώσεις ενίσχυσης δεξιοτήτων για την προώθηση της ένταξης των νέων στην κοινωνία, καθώς και της δημιουργίας ευκαιριών για απασχόληση και βιώσιμες καριέρες.",
            "image" => "all4youth.jpg"
        ],
        [
        ...
        [
            ...
            "image" => "1e20c-job_broker_logo_a.png"
        ],
        [
        ...
        [
            ...
            "image" => "1e739-aquats.jpg"
        ],
        [
            "title" => "e-Twinning_ Εργαστήριο για νέους",
            "startsFrom" => "01-02-2016",
            "endsAt" => "31-07-2018",
            "partners" => [
                ["name" => "Τμήμα Εκπαίδευσης", "country" => "Αγγλία"],
                ["name" => "Daphne", "country" => "Ελλάδα"]
            ],
            "website" => "http://www.etwinning.net/en/pub/index.htm",
            "authority" => "Ευρωπαϊκή Επιτροπή",
            "program_managing_entity" => "Επιτροπή",
            "description" => "",
            "image" => "34956-etwinning.jpg"
        ],
        [
